...
class Mesh {
    ...
    protected:
        ...
        std::unordered_map<int64_t2, uint64_t> uv_map; //each double is represented as an int, with 1 == 0.001 (3 decimal precision)
        std::vector<int64_t3> normal_coords;
        std::unordered_map<int64_t3, uint64_t> normal_map; //each double is represented as an int, with 1 == 0.001 (3 decimal precision)
